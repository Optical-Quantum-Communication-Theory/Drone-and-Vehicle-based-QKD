function qkdInput = ThreeStateDataAirtoCarDifInt_Preset_Run1()
...
%Load data
% Run 1
matdata = load("Data/ohioDataVarsObsAirtoCarRun1.mat");
...
%Run 1
qkdInput.addFixedParameter("N", 1368648961);
...
qkdInput.addFixedParameter("GROUP_decoys1_1", 0.16384); % decoy intensity 1 H
qkdInput.addFixedParameter("GROUP_decoys1_2", 0.17046); % R
qkdInput.addFixedParameter("GROUP_decoys1_3", 0.1689);% L

qkdInput.addFixedParameter("GROUP_decoys2_1", 0.0040462); % decoy intensity 2 H 
qkdInput.addFixedParameter("GROUP_decoys2_2", 0.0084189); % R
qkdInput.addFixedParameter("GROUP_decoys2_3", 0.0054067); % L

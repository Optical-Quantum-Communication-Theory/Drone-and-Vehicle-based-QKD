function qkdInput = ThreeStateDataCarDifInt_Preset()
...
%Run 1 Mar 27
matdata = load("Data/ohioDataVarsObsCarRun1Mar27.mat"); 

%Run 3 Mar 27
% matdata = load("Data/ohioDataVarsObsCarRun3Mar27.mat"); 

%Run 4 Mar 27
% matdata = load("Data/ohioDataVarsObsCarRun4Mar27.mat"); 

%Run 1 Apr 2
% matdata = load("Data/ohioDataVarsObsCarRun1Apr2_70Mph.mat");  

%Run 2 Apr 2
% matdata = load("Data/ohioDataVarsObsCarRun2Apr2_70Mph.mat"); 

%Run 1 and 2 combined Apr 2
% matdata = load("Data/ohioDataVarsObsCarRun1and2Apr2_70Mph.mat"); 


%Run 4 Nov 16
% matdata = load("Data/ohioDataVarsObsCarRun4Nov16.mat"); 

%Run 4 Nov 16 Free L
% matdata = load("Data/ohioDataVarsObsCarRun4Nov16FreeL.mat"); 
...
%% Modules
% description 
descriptionModule = QKDDescriptionModule(@ThreeStateDataCarDifInt_Desc);
...
keyModule = QKDKeyRateModule(@ThreeStateDataCarDifInt_KeyRateFunc, keyModuleOptions);

function [keyRate, modParser] = ThreeStateDataTableDifInt_KeyRateFunc(params,options,mathSolverFunc,mathSolverOptions,debugInfo)
...
% muMat = mu_beta_funcMat(params.N, squashedJointExp, params.tau, epsAT);
...
% %Independent LP
% [CondExpectationsL_Ind, CondExpectationsU_Ind] = decoyIndependent(squashedJointExp,reshapedIntensities,probSignalsTesting,decoyProbs,1-pGen,params.tau,muMat, ...
%    "decoySolver",options.decoySolver,"decoyTolerance",options.decoyTolerance,...
%     "decoyPrecision",options.decoyPrecision,"verboseLevel",options.verboseLevel);

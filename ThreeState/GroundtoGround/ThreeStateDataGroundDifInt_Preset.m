function qkdInput = ThreeStateDataGroundDifInt_Preset()
...
%Run 1 Nov 14
qkdInput.addFixedParameter("N", 2383250376);
...
qkdInput.addFixedParameter("GROUP_decoys1_1", 0.16697); % decoy intensity 1 H
qkdInput.addFixedParameter("GROUP_decoys1_2", 0.17594); % R
qkdInput.addFixedParameter("GROUP_decoys1_3", 0.17133);% L

qkdInput.addFixedParameter("GROUP_decoys2_1", 0.0034336); % decoy intensity 2 H 
qkdInput.addFixedParameter("GROUP_decoys2_2", 0.0054648); % R
qkdInput.addFixedParameter("GROUP_decoys2_3", 0.0040351); % L
...
%% Modules
% description 
descriptionModule = QKDDescriptionModule(@ThreeStateDataGroundDifInt_Desc);
...
keyModule = QKDKeyRateModule(@ThreeStateDataGroundDifInt_KeyRateFunc, keyModuleOptions);

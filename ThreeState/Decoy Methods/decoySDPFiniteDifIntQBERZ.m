...
function [Y1L,Y1U] = decoySDPFiniteDifIntQBERZ(expecJointTest,statesAlice,POVMsBob,decoys,probListAlice,probsDecoy,ptest,photonBound,t,mu,options)
    arguments
